...
public enum Language {
    ...
    public void parseYAMLData(String haveFileExtension, String noFileExtension, ConfigurationSection YAML) {
        if (YAML == null || YAML.getKeys(false).isEmpty()) {
            net.luckyblockpixelmon.maddyjace.util.Get.plugin().getLogger().warning(
    ...
    public static File getLanguageFolder() {
        File pluginFolder = net.luckyblockpixelmon.maddyjace.util.Get.plugin().getDataFolder();
        ...
        if (!taskFolder.exists()) {
            ...
            for (String path : DEFAULT_LANG_FILES) {
                net.luckyblockpixelmon.maddyjace.util.Get.plugin().saveResource(path, false);
            }
        }
        return taskFolder;
    }
    ...
    public static boolean isYamlFile(String name) {
